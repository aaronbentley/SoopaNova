...
export const XboxIcon = React.forwardRef<
    SVGSVGElement,
...
>(({ className, ...props }, ref) => (
    <svg
        ...
        viewBox='0 0 512 512'
        ref={ref}
        className={cn(['size-6', 'fill-muted-foreground'], className)}
        {...props}>
...
export const PlaystationIcon = React.forwardRef<
    SVGSVGElement,
    React.SVGProps<SVGSVGElement>
>(({ className, ...props }, ref) => (
    <svg
...
export const SteamIcon = React.forwardRef<
    SVGSVGElement,
    React.SVGProps<SVGSVGElement>
>(({ className, ...props }, ref) => (
    <svg
...
export const OneDriveIcon = React.forwardRef<
    SVGSVGElement,
    React.SVGProps<SVGSVGElement>
>(({ className, ...props }, ref) => (
    <svg
